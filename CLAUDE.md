...
1. `~/.claude/projects/nextjs-photo/memory/MEMORY.md`
   → Routing index. Tells you which files to read next.

2. `~/.claude/projects/nextjs-photo/memory/active-work.md`
   → What other agents are doing RIGHT NOW. Avoid their files.

3. `~/.claude/projects/nextjs-photo/memory/projects/nextjs-photo.md`
